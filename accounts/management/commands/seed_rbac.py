...
PERMISSION_LABELS = {
    ...
    'attendance_self': 'Own Attendance',
...
MENU_SEED = [
    ...
    ('Enquiries', 'enquiry_list', 'bi-chat-left-text', 'enquiries', 20),
    ('Orders', 'order_list', 'bi-clipboard-check', 'orders', 30),
    ('Clients', 'client_list', 'bi-people', 'clients', 40),
    ('Quotations', 'quotation_list', 'bi-file-earmark-ruled', 'quotations', 50),
    ('WCR', 'wcr_list', 'bi-file-earmark-text', 'wcr', 60),
    ('BOQ', 'boq_list', 'bi-list-check', 'boq', 70),
    ('Billing', 'invoice_list', 'bi-receipt', 'billing', 80),
    ('Attendance', 'attendance_dashboard', 'bi-calendar-check', 'attendance_manage', 90),
    ('Schedules', 'schedule_list', 'bi-calendar-event', 'scheduling', 100),
