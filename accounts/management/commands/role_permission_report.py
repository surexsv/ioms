...
MODULE_CHECKS = [
    ...
    ('Billing / Invoices', 'billing', 'View', bp.can_view_invoices),
    ('Billing / Invoices', 'billing', 'Create', bp.can_create_invoice),
    ('Billing / Invoices', 'billing', 'Edit', bp.can_create_invoice),
    ('Billing / Invoices', 'billing', 'Approve', bp.can_approve_invoice),
    ('Billing / Invoices', 'billing', 'Export PDF', bp.can_view_invoices),
    ('Billing / Invoices', 'billing', 'Delete', lambda u: False),
...
MENU_CHECKS = [
    ...
    ('Attendance', 'show_nav_attendance'),
